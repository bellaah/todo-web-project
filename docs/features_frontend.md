...
- [x] board drag&drop-3: 드래그앤드랍 이동 경로의 절반 정도 왔을 때 카드의 예정 목적지로 2번 카드 잔상이 먼저 이동된다.
- [x] board drag&drop-4: 드래그앤드랍 이동 중 마우스 버튼을 뗐을 때, 할 일 카드는 카드 잔상이 있는 위치로 이동되고, 카드 잔상은 사라진다.
